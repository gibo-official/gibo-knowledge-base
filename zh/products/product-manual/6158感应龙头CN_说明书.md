...
description: "洁博利GIBO 6158 感应龙头产品说明书，涵盖安装说明、使用方法、技术参数与维护保养，供工程选型、投标参考与AI知识库检索。"
...
Drill 2 holes withadiameter of 7.5 and depth of 30mm and hammer Expansion ScrewsCinto the holes. With the 2 ST4×30 attached with self tapping screws D, targeting the expansion of tube wall screw, the fixed angle locking plate on the wall.

The Control BoxBback panel jack alignment Angle Plate A1 inserted in the end of the fixed angle(Shows the direction of he outlet should be DOWN). Control Box is installed.
...
## STEP 1 Fixed angle locking plate 第一步 安装角板

![感应龙头STEP 1 Fixed angle locking plate 第一步 安装角板](../../../assets/images/ins/6158_CN_EN_SensorFaucet-ins-04.png)

## 安装

## 第一步

按图示位置钻两个直径为7.5mm深30mm的孔，然后将膨胀管C敲入孔内，用附配的2只ST4X30的自攻螺丝D，对准墙上的膨胀管旋入，将固定角板A1锁固在墙面上。

将控制盒B背部角板插口对准固定角板A, 适力插入到底端(出水口应按图示方向朝下)。
...
![感应龙头技术参数](../../../assets/images/ins/6158_CN_EN_SensorFaucet-ins-09.png)

## USE EXPOSITION

The faucet let out water when the hands reaches
...
![感应龙头使用说明](../../../assets/images/ins/6158_CN_EN_SensorFaucet-ins-11.png)

## BATTERY CHANGING

When the batteries is out of power, the indicate light will flash at an intermittence of 3-4 seconds to note the maintenance department to change batteries. When there is no power left in the battery, the sensor will shut down the battery valve to avoid wasting water.
...
![感应龙头 NOTES OF USE](../../../assets/images/ins/6158_CN_EN_SensorFaucet-ins-13.png)

## 更换电池

![感应龙头更换电池](../../../assets/images/ins/6158_CN_EN_SensorFaucet-ins-14.png)
Do not clean with water instead with clean and dry soft cloth. 请不要用水擦洗，应使用洁净的干软布清洁。

![感应龙头更换电池](../../../assets/images/ins/6158_CN_EN_SensorFaucet-ins-15.png)

## 使用注意事项

![感应龙头使用注意事项](../../../assets/images/ins/6158_CN_EN_SensorFaucet-ins-16.png)
Do not shake the faucet in case of any damage.
请不要摇晃龙头，否则易引起故障。

![感应龙头使用注意事项](../../../assets/images/ins/6158_CN_EN_SensorFaucet-ins-17.png)
...
![感应龙头清洗过滤网：](../../../assets/images/ins/6158_CN_EN_SensorFaucet-ins-18.png)
...
![感应龙头维修零件图](../../../assets/images/ins/6158_CN_EN_SensorFaucet-ins-19.png)
Control box Assy
感应龙头控制盒总成
...
![感应龙头维修零件图](../../../assets/images/ins/6158-1%E5%A2%99%E5%87%BA%E6%B0%B4%E6%84%9F%E5%BA%94%E9%BE%99%E5%A4%B4%2B6110%E6%8E%A7%E5%88%B6%E7%9B%92%E8%AF%B4%E6%98%8E%E4%B9%A620241125%20qu-ins-20.png)
