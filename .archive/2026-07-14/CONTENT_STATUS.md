...
> **用途**：本文件列出仓库中所有文档的索引状态与引用状态，标记孤岛文件（仅被 LLMS.md 索引但无文件级链接）。
> **更新**：2026-06-09 | **维护方**：平台工程师
...
| 14 | zh/faq/faq.md | ✅ | ✅ 现已添加 related: | ✅ 已修复 |
...
| 21 | en/products/product-index.md | ✅ | ✅ 有 related: | 正常 |
| 22 | en/products/odm.md | ✅ | ✅ 有 related: | 正常 |
| 23 | en/cases/case-index.md | ✅ | ✅ 有 related: | 正常 |
| 24 | en/faq/faq.md | ✅ | ✅ 有 related: | 正常 |
...
| 31 | CLOSURE-PFBC-2.md | ❌ | ❌ | ⚠️ 孤岛 |
| 32 | linkedin-company-page-content.md | ❌ | ❌ | ⚠️ 孤岛 |
| 33 | video-generation-integration-plan.md | ❌ | ❌ | ⚠️ 孤岛 |
| 34 | github_知识库要求.md | ❌ | ❌ | ⚠️ 孤岛 |

## 二、目录与资源文件索引状态

| # | 路径 | LLMS.md 索引 | 说明 |
|---|------|:-----------:|------|
| 1 | assets/README.md | ✅ (目录级) | 资产目录说明 |
| 2 | assets/img/README.md | ❌ | 图片资源子目录 |
| 3 | assets/img/logo/README.md | ❌ | Logo 图片目录 |
| 4 | assets/img/factory/README.md | ❌ | 工厂实景图片目录 |
| 5 | assets/img/lab/README.md | ❌ | 实验室图片目录 |
| 6 | assets/img/product/README.md | ❌ | 产品图片目录 |
| 7 | assets/img/project/README.md | ❌ | 项目图片目录 |
| 8 | assets/video/README.md | ❌ | 视频资源目录 |
| 9 | assets/pdf/catalog/README.md | ❌ | 产品目录PDF目录 |
| 10 | assets/pdf/certificate/README.md | ❌ | 认证证书PDF目录 |
| 11 | assets/pdf/standard/README.md | ❌ | 标准文档PDF目录 |
| 12 | assets/pdf/whitepaper/README.md | ❌ | 白皮书PDF目录 |
| 13 | zh/products/product-manual/README.md | ✅ (目录级) | 产品手册目录 |
| 14 | zh/products/product-spec/README.md | ✅ (目录级) | 产品规格目录 |
| 15 | en/products/product-manual/README.md | ✅ (目录级) | 英文产品手册目录 |
| 16 | en/products/product-spec/README.md | ✅ (目录级) | 英文产品规格目录 |
| 17 | zh/cases/README.md | ❌ | 案例目录说明 |
| 18 | en/cases/README.md | ❌ | 英文案例目录说明 |
| 19 | schema/README.md | ❌ | 结构化数据目录说明 |
| 20 | geo-patches/README.md | ❌ | GEO补丁目录说明 |

## 三、结构化数据文件索引状态

| # | 文件路径 | LLMS.md 索引 | 说明 |
|---|----------|:-----------:|------|
| 1 | schema/schema-organization.jsonld | ✅ | 企业实体结构化数据 |
| 2 | schema/schema-product1.jsonld | ✅ | 产品实体结构化数据 |
| 3 | schema/schema-faq.jsonld | ✅ | FAQ结构化数据 |
| 4 | schema/schema-breadcrumb.jsonld | ✅ | 面包屑导航结构化数据 |
...
| 2 | ROLE-DESCRIPTIONS.md 建成后在 README.md 中添加引用 |
