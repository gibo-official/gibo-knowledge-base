...
## 7. To Be Added (Provide Tencent Doc Content)

> The originally requested Tencent doc (`doc.weixin.qq.com/doc/w3_AKkAKQZaAMUCNb0mig65eQIq2oZJ2`) requires WeChat Work identity login and could not be auto-read in the current environment. If that doc contains **specific certificate query direct links / certification numbers / test-report links**, please paste the content and I will merge it into §2 "Certifications" with added verification entries.
