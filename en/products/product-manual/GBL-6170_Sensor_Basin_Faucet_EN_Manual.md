...
●The installation process is easy to implement, but we highly recommended that the plumbing is carried out by a qualified plumber.
...
Screw off the U shape gasket and hex nut at the bottom of the faucet, then screw the inlet hose tightly on the faucet.

Third step:

Insert the faucet main body into the basin, keep the faucet opposite to the basin, and lock the faucet body from the bottom by U shape gasket and hex nut.
...
06. Safety. PPO integrated watercourse design,The precipitation of heavy metal and other harmful substances are much lower than the national standard, real environmental protection; High pressure hose, safe and reliable 07.Stability. Integrated, modular structure design, Greatly improve the structure accuracy, Eliminate leakage, valve core leakage and other annoying phenomenon.

08.Durability. The core components of the solenoid valve and sensor module have passed 1,000,000 time endurance test.

09.Waterproof. The waterproof design for whole product with grade IP54(splash proof type). 10.Functional protection. Weak power indicating function, Power-off automatic shutoff valve function 1 minute timeout protection function for hand-washing, 3 minutes timeout protection function for taking water, and mandatory shutoff function
...
\*Our company has an extensive quality promise to the end customers. Our products proved to be correctly installed and properly used enjoy a maintenance period of 1 year during which an products with quality defects shall be repaired without any charge.
...
> **Related Documents**: [GIBO 6170 Sensor Faucet Product Manual](6170_Sensor_Faucet_EN_Manual.md) | [GIBO 9160 Sensor Faucet Product Manual](9160_Sensor_Faucet_EN_Manual.md) | [GIBO 6122 Sensor Faucet Product Manual](6122_Sensor_Faucet_EN_Manual.md) | [GIBO 1051 Sensor Faucet Product Manual](1051_Sensor_Faucet_EN_Manual.md) | [GIBO 6196 Sensor Faucet Product Manual](6196_Sensor_Faucet_EN_Manual.md)
